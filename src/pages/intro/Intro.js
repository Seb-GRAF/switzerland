  ...
  return (
    <section className="intro" data-scroll-section>
      ...
      <DescriptionSection img={require("../../assets/photos/intro5.jpg")}>
        ...
        <p>
          But its mountain-walled valleys are far more likely to echo the music
          of a local rock band than a yodel or an alphorn. Most Swiss live in
          towns and cities, not in the idyllic rural landscapes that you can see
      ...
      <DescriptionSection img={require("../../assets/photos/intro7.jpg")}>
        <p>
          ...
          Thus, one of the country’s distinctive features is the variety of its
          languages.
        </p>
        <p>
          ...
          mountainous regions, has had official status at the federal level for
          communicating with Romansh-speaking persons (it had been designated as
          an official “national” language in 1938).
        </p>
      </DescriptionSection>
      <DescriptionSection img={require("../../assets/photos/intro8.jpg")}>
        <p>
          As a country where diverse traditions and cultures meet and interact,
          Switzerland has been a melting-pot in the heart of Europe since time
          immemorial. This is why cultural life in cosmopolitan Switzerland
          displays such enormous variety.
        </p>
        <p>
          There is no such thing as "typically Swiss art". There is a clear and
          repeated focus on the Alps as a living environment. The tendency to be
          modest is also a recurrent theme. But by and large, the arts in
          Switzerland are just as diverse as the country itself.
        </p>
        <p>
          For example, Switzerland has won more Nobel Prizes and registered more
          patents per capita than any other country, and the country abounds in
          cultural institutions, museums, and libraries, all well supported with
          federal funds.
        </p>
      </DescriptionSection>
    </section>
